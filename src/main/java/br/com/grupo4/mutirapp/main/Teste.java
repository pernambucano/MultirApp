...
//		
//		Acao acaoTeste1 = new Acao(u1,TipoCategoria.MEIO_AMBIENTE,"Limpar a praia", "Precisamos limpar a praça", new Date(1475111860), new Date(1475111860), "50711340", "PE", "Recife", "Rua orós", "Cordeiro", TipoStatus.EM_ABERTO);
...
//		
//		// Cadastrando acao de novo pra ter mais dados pros próximos testes
//		
...
//		}
//		
//		// M�todos de Usu�rio que tem rela��o com A��o/Interesse
//		
