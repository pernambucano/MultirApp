...
public class Teste {
	public static void main(String[] args) {
		...
		Acao acaoTeste1 = new Acao(u1,TipoCategoria.MEIO_AMBIENTE,"Limpar a praça", "Precisamos limpar a praça", new Date(1475111860), new Date(1475111860), "50711340", "PE", "Recife", "Rua orós", "Cordeiro", TipoStatus.EM_ABERTO);
